...
export const en = {
  ...
  "prompt.projectPending" : "{units} pending, ~{tokens} tokens",
  "prompt.projectDone"    : "done",
  "prompt.planFinish"     : "Finish here",
  "prompt.quotaSpent"     : "The provider ran out of quota. {generated} of {total} units generated.",
  ...
  "generate.resuming"            : "{pending} units pending, {cached} already generated",
  "generate.largePlan"           : "This project has {units} units (~{tokens} estimated tokens).",
