...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "prompt.projectPending" : "{units} pendientes, ~{tokens} tokens",
  "prompt.projectDone"    : "hecho",
  "prompt.planFinish"     : "Terminar aquí",
  "prompt.quotaSpent"     : "Se agotó la cuota del proveedor. {generated} de {total} units generadas.",
  ...
  "generate.resuming"            : "{pending} units pendientes, {cached} ya generadas",
  "generate.largePlan"           : "Este proyecto tiene {units} units (~{tokens} tokens estimados).",
  ...
  "eject.done"            : "{count} páginas escritas en {path}",
  "eject.skipped"         : "{count} units todavía no tienen página y quedaron fuera",
