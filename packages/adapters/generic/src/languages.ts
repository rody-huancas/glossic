/**
 * Extension -> language. Only entries listed here count as source code, so
 * this map also decides which directories become units.
 */
...
/** Returns the language for a path, or undefined when it is not source code. */
